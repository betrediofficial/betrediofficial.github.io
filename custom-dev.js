...
<div class="row row-cols-3 row-cols-xl-6 flex-nowrap g-8">
      <div class="sport-card col" style="position: relative; overflow: hidden !important; border: 2px solid #9B000E; border-top-right-radius: 32px; border-bottom-left-radius: 32px; padding: 0 !important;">
      <div style="position: absolute; width: 100%; height: 100%; background: rgba(255, 255, 255, 0.15); z-index: 10;"></div>
        <a href="/sportsbook">
