...
<div class="otherGamesComponentLayout extra-game" style="position: relative; cursor: pointer; border: 2px solid #9b000e; overflow: hidden; border-radius: 16px !important;">
  ...
  <a href="casino/games/pragmaticlive-big-bass-crash">
    ...
    function gameChooser() {
              ...
              <div class="landing-inner position-relative">
                <div class="chooser py-auto py-sm-5">
                  <div class="d-block mb-4 mb-sm-5">
                    <h1 class="text-white fw-bold lh-sm mb-0 text-center">Need help choosing a game?</h1>
                  </div>
                  <div class="chooser-inner mx-auto px-4 px-sm-5 py-4 rounded-5">
                    <div class="chooser-wrapper d-flex gap-3 overflow-hidden position-relative px-4 rounded-4">
                      <div class="chooser-list d-flex flex-column justify-content-center w-100 first" style="--list-height: 924.75px;">
                      ...
                      <div class="chooser-list d-flex flex-column justify-content-center w-100 second" style="--list-height: 924.75px;">
                      ...
                      <div class="chooser-border position-absolute top-50 rounded-4 pe-none" style="height: 174.95px;"></div>
                    </div>
                    <div class="d-block text-center">
                      <a href="?modal=register" class="spin-button d-block w-75 mx-auto text-white rounded-3 border mt-4">Sign Up &amp; Spin</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      $("#buy-bonus-games-wrapper").after(gameChooser);
    }
