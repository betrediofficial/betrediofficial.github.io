...
`;
  ...
  <div class="manually-added-home-widgets section" id="tgpromo" style="margin-bottom: 14px; margin-top: 14px;">
    <div class="container otherGames">
      ...
      <img src="https://betrediofficial.github.io/images/tg-promo/reditg.gif" style="border: 3px solid #9b000e; border-radius: 10px" alt="Telegram Promo GIF" style="display: block; width: 100%; margin-bottom: 10px;" />
